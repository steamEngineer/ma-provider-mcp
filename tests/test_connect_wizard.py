...
async def wizard_client(wizard_mass: MagicMock) -> AsyncIterator[TestClient]:
    ...
    from provider.connect.mount import mount_connect_wizard  # noqa: PLC0415
...
async def test_action_handler_signals_url_with_bootstrap(
    ...
    from provider.connect.actions import handle_open_connect_action  # noqa: PLC0415
...
def test_cursor_template_round_trips() -> None:
    ...
    from provider.connect.clients import lookup_client  # noqa: PLC0415
...
def test_all_clients_have_required_fields() -> None:
    ...
    from provider.connect.clients import CLIENTS  # noqa: PLC0415
