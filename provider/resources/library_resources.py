...
def register_library_resources(mcp: Any, mass: MusicAssistant) -> None:
    ...
    @mcp.resource("library://artist/{artist_id}", tags={Tag.QUERY_LIBRARY})  # type: ignore[misc]
    ...
    @mcp.resource("library://album/{album_id}", tags={Tag.QUERY_LIBRARY})  # type: ignore[misc]
    ...
    @mcp.resource("library://track/{track_id}", tags={Tag.QUERY_LIBRARY})  # type: ignore[misc]
    ...
    @mcp.resource("library://playlist/{playlist_id}", tags={Tag.QUERY_LIBRARY})  # type: ignore[misc]
    ...
    @mcp.resource("library://radio/{radio_id}", tags={Tag.QUERY_LIBRARY})  # type: ignore[misc]
